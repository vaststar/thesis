...
\par\vspace{.6em}
\hspace{2.5em}
\makebox[0.2\textwidth][s]{\bfseries 题~~~~目}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 电子商务对国际贸易的促进及研究}}
\par\vspace{.6em}
\hspace{2.5em}
\makebox[0.2\textwidth][s]{\bfseries 学生姓名}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 姚~枝~叶~~~~~~}}
\par\vspace{.6em}
\hspace{2.5em}
