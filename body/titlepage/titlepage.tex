...
\begin{center}
%--------------图标-----------------	
\includegraphics[width=0.9\textwidth]{body/titlepage/title.jpg}\\\vspace{1.2em}
%------------论文名和作者---------------------
{
\cukai \fontsize{32pt}{\baselineskip}\selectfont 成~教~毕~业~设~计~报~告
}\par\vspace{3.3em}
...
%--------------格式---------------------
\makebox[0.2\textwidth][s]{\bfseries 指导教师姓名}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 赵~琦~~~~~~~教~授}}\par\vspace{.6em}
\makebox[0.2\textwidth][s]{}\hspace{.5em}\underline{\makebox[0.6\textwidth]{}}\par\vspace{.6em}
\makebox[0.2\textwidth][s]{\bfseries 学~~位~~类~~别}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 工~学~硕~士}}\par\vspace{.6em}
\makebox[0.2\textwidth][s]{\bfseries 学~~科~~名~~称}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 光~学~工~程}}\par\vspace{.6em}
\makebox[0.2\textwidth][s]{\bfseries 研~~究~~方~~向}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 光~传~输~特~性}}\par\vspace{.6em}
\makebox[0.2\textwidth][s]{\bfseries 论文提交时间}\hspace{.5em}\underline{\makebox[0.6\textwidth]{
\cukai 2016年01月}}\par\vspace{.6em}
\end{titlepage}
%----------插入空白页面-------
